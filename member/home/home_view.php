                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="details">
                            <div class="number">
                                 <?php
									$whrstr = "AND users_id='".$_SESSION['users_id']."'";	
									$info["table"] = "transactions";
									$info["fields"] = array("sum(credit-debit) as total_due"); 
									$info["where"]   = "1   $whrstr";
									$arr =  $db->select($info);
									echo "$".$arr[0]['total_due'];
                                 ?>
                            </div>
                            <div class="desc">
                               Total Due amount
                 ...
                 <div class="row">  
                    <div class="col-md-12 col-sm-12">
                     Refferal Link : <br>
                     <a href="http://www.abc.com/aca/?ref=<?=$_SESSION["phone_no"]?>" target="_blank"><b>http://www.abc.com/aca/?ref={refferal code (Phone No)}</b></a> <br>
                     Phone No:<?=$_SESSION["phone_no"]?>
                    </div> 
                 </div>
			<!-- END DASHBOARD STATS -->
			<div class="clearfix">
