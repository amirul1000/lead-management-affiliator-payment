...
<div class="portlet box blue">
      ...
      <div class="table-responsive">	
         ...
         ?>
			  ...
			  <tr><td>Arrea Code</td>
			  <td><?=$arr[$i]['arrea_code']?></td></tr>
			  <tr><td>Phone No</td>
			  <td><?=$arr[$i]['phone_no']?></td></tr>
			  <tr><td>Dob</td>
			  <td><?=$arr[$i]['dob']?></td></tr>
			  <tr><td>Address Line 1</td>
			  <td><?=$arr[$i]['address_line_1']?></td></tr>
			  <tr><td>Address Line 2</td>
			  <td><?=$arr[$i]['address_line_2']?></td></tr>
			  <tr><td>City</td>
			  <td><?=$arr[$i]['city']?></td></tr>
			  <tr><td>State</td>
			  ...
			  <td><?=$arr[$i]['paid_amount']?></td></tr>
			  <tr><td>Paid Status</td>
			  <td><?=$arr[$i]['paid_status']?></td></tr>
			  <tr><td>Entry Type</td>
			  <td><?=$arr[$i]['entry_type']?></td></tr>
			  <tr><td>Created At</td>
