...
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","admin_contact"))?></a> <br><br>
 <div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","admin_contact"))?></b>
                </div>
                <div class="tools">
	         ...
	         <div class="table-responsive">	
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("admin_contact");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_admin_contact" >
			  ...
			  <td>Phone</td>
						 ...
						 <?php
								...
								$info["fields"] = array("admin_contact.*"); 
			  ...
			  <td><?=$arr[$i]['phone']?></td>
                              ...
                              <td nowrap >
								  ...
								  <a  href="javascript:void();"  onClick="popUp('index.php?cmd=admin_contact_details&id=<?=$arr[$i]['id']?>')" class="btn blue button-next">
									   Details
