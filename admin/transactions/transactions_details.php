...
<div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","transactions"))?> details</b>
                </div>
            </div>
      ...
      <div class="table-responsive">	
         ...
         ?>
			  ...
			  <tr><td>Debit</td>
			  <td><?=$arr[$i]['debit']?></td></tr>
			  <tr><td>Credit</td>
			  <td><?=$arr[$i]['credit']?></td></tr>
			  <tr><td>Refference</td>
			  <td><?=$arr[$i]['refference']?></td></tr>
			  <tr><td>Date Time Created</td>
			  <td><?=$arr[$i]['date_time_created']?></td></tr>
			  <tr><td>Date Time Updated</td>
			  <td><?=$arr[$i]['date_time_updated']?></td></tr>
