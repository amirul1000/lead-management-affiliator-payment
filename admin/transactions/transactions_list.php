...
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","transaction"))?></a> <br><br>
<div class="row">
    <code>
					...
					<div class="dashboard-stat green-haze">
						...
						<div class="details">
							...
							<?php
								...
								$info["table"] = "transactions";
								$info["fields"] = array("sum(credit) as total_credit"); 
								$info["where"]   = "1   $whrstr";
								$arr =  $db->select($info);
								echo $arr[0]['total_credit'];
                             ?>
							</div>
							<div class="desc">
								Total Credited(Earned)
							</div>
						</div>
						<a class="more" href="../transactions">
						View more <i class="m-icon-swapright m-icon-white"></i>
					...
					<div class="dashboard-stat purple-plum">
						...
						<div class="details">
							<div class="number">
								...
								$info["table"] = "transactions";
								$info["fields"] = array("sum(debit) as total_debit"); 
								$info["where"]   = "1   $whrstr";
								$arr =  $db->select($info);
								echo $arr[0]['total_debit'];
                             ?>
							</div>
							<div class="desc">
								Total Debited(Paid)
				                ...
				                <table align="right">
									  <TR>
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_transactions" >
					 ...
					 <div class="portlet-body">
				      <div class="table-responsive">	
						 ...
						 <?php
								...
								$info["table"] = "transactions";
								$info["fields"] = array("transactions.*"); 
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td nowrap >
								  ...
								  <a  href="javascript:void();"  onClick="popUp('index.php?cmd=transactions_details&id=<?=$arr[$i]['id']?>')" class="btn blue button-next">
									   Details
