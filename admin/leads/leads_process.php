...
<div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b>Process</b>
                </div>
            </div>
            ...
            <div class="portlet-body">
             <div class="table-responsive">
               ...
               <table>
                   <tr>
                       <td>
                           Payment $<input type="text" name="payment" id="payment"  value="20" class="form-control-static" required>
                       </td>
                       <td>
                          To Forward call <input type="text" name="phone_no" id="phone_no"  value="<?=$arr[0]['arrea_code']?><?=$arr[0]['phone_no']?>" class="form-control-static">
                       </td>
                       <td>
                            <input type="hidden" name="cmd" value="add">
                            <input type="hidden" name="id" value=" <?=$arr[0]['id']?> ">			
                            <input type="submit" name="btn_submit" id="btn_submit" value="Forward Call" class="btn red">
                       </td>
                   </tr>
               </table>
