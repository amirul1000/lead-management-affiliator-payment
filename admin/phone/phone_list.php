...
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","phone"))?></a> <br><br>
	         ...
	         <div class="table-responsive">	
				                ...
				                <table align="right">
									  <TR>
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_phone" >
			  ...
			  <td><?=$arr[$i]['status']?></td>
                              ...
                              <td nowrap >
								  ...
								  <a  href="javascript:void();"  onClick="popUp('index.php?cmd=phone_details&id=<?=$arr[$i]['id']?>')" class="btn blue button-next">
									   Details
