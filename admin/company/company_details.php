...
<div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","company"))?> details</b>
                </div>
            </div>
      ...
      <div class="table-responsive">	
         ...
         ?>
			  ...
			  <td><?=$arr[$i]['company_name']?></td></tr>
			  <tr><td>Address</td>
			  <td><?=$arr[$i]['address']?></td></tr>
			  <tr><td>Country</td>
			  <td><?=$arr[$i]['country']?></td></tr>
			  <tr><td>City</td>
			  <td><?=$arr[$i]['city']?></td></tr>
			  <tr><td>State</td>
			  ...
			  <tr><td>Zip</td>
			  <td><?=$arr[$i]['zip']?></td></tr>
			  <tr><td>File Company Logo</td>
			  <td><?=$arr[$i]['file_company_logo']?></td></tr>
			  <tr><td>File Report Logo</td>
			  <td><?=$arr[$i]['file_report_logo']?></td></tr>
			  <tr><td>File Report Background</td>
			  <td><?=$arr[$i]['file_report_background']?></td></tr>
			  <tr><td>Report Footer</td>
			  <td><?=$arr[$i]['report_footer']?></td></tr>
