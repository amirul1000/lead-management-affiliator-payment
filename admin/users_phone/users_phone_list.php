...
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","users_phone"))?></a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("users_phone");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_users_phone" >
                             ...
                             <td>
			                   ...
			                   <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = phone;	
										$info2['fields']   = array("phone_no");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['phone_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['phone_no'];	
					                ?>
							   </td>
			                  <td><?=$arr[$i]['status']?></td>
                              ...
                              <td nowrap >
								  ...
								  <a  href="javascript:void();"  onClick="popUp('index.php?cmd=users_phone_details&id=<?=$arr[$i]['id']?>')" class="btn blue button-next">
									   Details
