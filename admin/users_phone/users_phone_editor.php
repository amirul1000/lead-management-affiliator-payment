...
?>
<script language="javascript" src="users_phone.js"></script>
...
<a href="index.php?cmd=list" class="btn green"><i class="fa fa-arrow-circle-left"></i> List</a> <br><br>
  <div class="portlet box blue">
      <div class="portlet-title">
          <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","users_phone"))?></b>
          </div>
          <div class="tools">
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_users_phone" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
                                             ...
                                             <td><?php
												...
												<select  name="users_id" id="users_id"   class="form-control-static">
													...
													<?php
													   ...
													   { 
													?>
													  <option value="<?=$resusers[$key]['id']?>" <?php if($resusers[$key]['id']==$users_id){ echo "selected"; }?>><?=$resusers[$key]['first_name']?> <?=$resusers[$key]['last_name']?><?=$resusers[$key]['email']?></option>
													<?php
													 }
													?> 
												</select></td>
                                      ...
                                      <tr>
										...
										?>
										<select  name="phone_id" id="phone_id"   class="form-control-static">
											<option value="">--Select--</option>
											<?php
                                      ...
                                      <tr>
                                         <td>Status</td>
                                                     <td><?php
                                                $enumusers_phone = getEnumFieldValues('users_phone','status');
                                            ?>
                                            <select  name="status" id="status"   class="form-control-static">
                                            <?php
                                               foreach($enumusers_phone as $key=>$value)
                                               { 
                                            ?>
